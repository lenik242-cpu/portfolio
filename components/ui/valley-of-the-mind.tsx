...
// ShaderBackground — generated by the 21st.dev Shader Builder ("Mesh
// drift"). Zero dependencies: one WebGL canvas that fills its parent. Drop
// it behind content with <div className="relative"><ShaderBackground
// className="absolute inset-0" />…
//
// Recouleurs uniquement : la palette (u_colors) est celle du site — obsidienne
// → indigo → bleu accent → lavande spectrale (voir --color-accent /
// --color-accent-blue dans globals.css) — au lieu de la palette violet/teal
// d'origine. Tous les autres paramètres (mouvement, grain, vignette) sont
// inchangés.
...
const UNIFORMS = {
  // obsidienne → indigo → accent bleu → lavande spectrale (palette du site).
  // colorCount = 4 ; les 4 emplacements restants répètent la dernière
  // couleur (contrainte WebGL1 : le tableau u_colors[8] doit être plein).
  colors: [
    [0.0196078431372549, 0.027450980392156862, 0.054901960784313725], // #05070e
    [0.07764705882352942, 0.11294117647058823, 0.2611764705882353], // #16204a, assombri
    [0.25333333333333335, 0.4166666666666667, 0.85], // #4c7dff, assombri — accent
    [0.4766666666666667, 0.4133333333333333, 0.85], // #8f7cff, assombri — lavande, rare
    [0.4766666666666667, 0.4133333333333333, 0.85],
    [0.4766666666666667, 0.4133333333333333, 0.85],
    [0.4766666666666667, 0.4133333333333333, 0.85],
    [0.4766666666666667, 0.4133333333333333, 0.85],
